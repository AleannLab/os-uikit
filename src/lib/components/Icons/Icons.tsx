...
const AppleIcon = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    />
    <path
      d="M27.7122 21.7403C27.9901 21.9424 28.0802 22.3123 27.923 22.6136C25.3931 27.5442 23.3749 30 21.531 30C20.6724 30 19.8291 29.7293 19.0068 29.203C18.4167 28.8261 17.7333 28.6188 17.0321 28.604C16.331 28.5892 15.6393 28.7674 15.0336 29.1191C14.037 29.7007 13.0882 30 12.1874 30C9.47536 30 5 21.8643 5 17.4008C5 12.6341 7.56638 9 11.4687 9C13.3048 9 14.8899 9.26312 16.2219 9.79889C16.7854 10.0239 17.4237 10.0086 17.9738 9.75123C19.0547 9.24405 20.4807 9 22.2479 9C24.4079 9 26.292 10.0487 27.856 12.0793C27.9125 12.1525 27.9538 12.2363 27.9772 12.3256C28.0006 12.415 28.0058 12.5081 27.9924 12.5995C27.979 12.6909 27.9473 12.7787 27.8992 12.8577C27.851 12.9366 27.7875 13.0052 27.7122 13.0593C25.9662 14.3368 25.1247 15.7687 25.1247 17.4008C25.1247 19.031 25.9662 20.4648 27.7122 21.7403Z"
      fill="black"
    />
  </svg>
);
...
const GoogleIcon = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    />
    <path
      d="M4.20401 9.79408L8.58468 13.0067C9.77001 10.0721 12.6407 8.00008 16 8.00008C18.0393 8.00008 19.8947 8.76941 21.3073 10.0261L25.0787 6.25475C22.6973 4.03541 19.512 2.66675 16 2.66675C10.8787 2.66675 6.43734 5.55808 4.20401 9.79408Z"
      fill="#FF3D00"
    />
    <path
    ...
    />
    <path
      d="M29.074 13.3886H28V13.3333H16V18.6666H23.5353C23.0095 20.1442 22.0622 21.4354 20.8107 22.3806L20.8127 22.3793L24.9393 25.8713C24.6473 26.1366 29.3333 22.6666 29.3333 15.9999C29.3333 15.1059 29.2413 14.2333 29.074 13.3886Z"
      fill="#1976D2"
    />
  </svg>
);
