import { ComponentProps, KeyboardEvent, MouseEvent, useMemo, forwardRef } from 'react';
...
export const ToggleSwitch: any = forwardRef<HTMLInputElement, ToggleSwitchProps>(
  ({ checked, className, disabled, label, name, onChange, ...props }, ref) => {
